...
<head>
    ...
    <link rel="stylesheet" href="css/stytrans.css" />
<link rel="stylesheet" href="css/fontello.css" />
    <title>Delishopmx</title>
</head>
<body>
            ...
            <nav class="nav">
                <ul class="list">
                    ...
                    <li class="list_item list_item--click">
                        ...
                        <ul class="list_show">
                            <li class="list_inside">
                                <a href="#" class="nav_link nav_link--inside">Ver pedidos</a>
                            </li>
    ...
    <footer>
        <div class="contenedorrr-footer">
            <div class="contenttt-fo">
                <h4>DeliShop&reg;</h4>
        ...
        <h2 class="titulo-finalll">&copy; DeliShop | UTTEC</h2>
