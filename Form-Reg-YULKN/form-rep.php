...
<body>
    ...
    <form id="formreg" >
        ...
        <div class="form">
            ...
            <div class="group">
                <input type="text" name="licencia" id="Tipo" required><span class="barra"></span>
                <label for="E1">Tipo de licencia</label>
            </div>
            <div class="group">
                <input type="text" name="car" id="" required><span class="barra"></span>
            ...
            if(!$validar):
            ?> 
            <p>¿Ya tienes una cuenta?</p> <a href="http://localhost/form-reg-yulkn/login.html" class="log">Inicia Sesión</a>
<?php
endif;
?>
        </div>
