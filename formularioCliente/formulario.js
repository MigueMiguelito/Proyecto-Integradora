...
const expresiones = {
	...
	fecha: /^(?:3[01]|[12][0-9]|0?[1-9])([\-/.])(0?[1-9]|1[1-2])\1\d{4}$/, //fecha de nacimiento
	password: /^.{4,6}$/, // 4 a 6 digitos.
...
formulario.addEventListener('submit', (e) => {
	...
	if( campos.nombre && campos.apaterno && campos.amaterno && campos.fecha && campos.password && campos.correo ){
		formulario.reset();
